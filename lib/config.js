...
module.exports = {
  ...
  logging: {
    ...
    maxSizeBytes: num('LOG_MAX_SIZE_BYTES', file.logging && file.logging.maxSizeBytes, 5 * 1024 * 1024),
    maxBackups: num('LOG_MAX_BACKUPS', file.logging && file.logging.maxBackups, 3)
  },
  executor: {
  ...
  pathfinder: {
    thinkTimeoutMs: num('PATHFINDER_THINK_TIMEOUT', file.pathfinder && file.pathfinder.thinkTimeoutMs, 350),
    tickTimeoutMs: num('PATHFINDER_TICK_TIMEOUT', file.pathfinder && file.pathfinder.tickTimeoutMs, 3),
    searchRadius: num('PATHFINDER_SEARCH_RADIUS', file.pathfinder && file.pathfinder.searchRadius, 12)
  }
}
