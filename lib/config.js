...
module.exports = {
  ...
  mc: {
    ...
    reconnectBaseDelayMs: num('MC_RECONNECT_BASE_DELAY_MS', file.mc && file.mc.reconnectBaseDelayMs, 3000),
    reconnectMaxDelayMs: num('MC_RECONNECT_MAX_DELAY_MS', file.mc && file.mc.reconnectMaxDelayMs, 60000),
  ...
  ai: {
    ...
    planIntervalMs: num('AI_PLAN_INTERVAL_MS', file.ai && file.ai.planIntervalMs, 180000),
    awakeningEnabled: bool('AI_AWAKENING_ENABLED', file.ai && file.ai.awakeningEnabled, false),
    awakeningIntervalMs: num('AI_AWAKENING_INTERVAL_MS', file.ai && file.ai.awakeningIntervalMs, 120000),
    fallbackBaseUrl: str('AI_FALLBACK_BASE_URL', file.ai && file.ai.fallbackBaseUrl, ''),
    fallbackApiKey: str('AI_FALLBACK_API_KEY', file.ai && file.ai.fallbackApiKey, ''),
    fallbackModel: str('AI_FALLBACK_MODEL', file.ai && file.ai.fallbackModel, '')
  },
  api: {
