...
1. ???????? set_goal(goal) ??????? plan(todos) ?????????? set_goal ????????????????? finish/?????????????
2. ???? scan ??????????????? query ???????????????????????????????? query_block ??????query_building ??????? verify_path ????????????
3. ????? build_plan ? shape ?????fill/wall/box/floor/door/stairs/ladder/spiral/clear???????? shape ??????????? place/dig????? craftPlanks/craftGear?
4. ??????????? previousResults???????/???/??????? verify_path ? scan ?????
5. ???????? remember ?????????? recall ???????????????????????
6. ??????????????????????? finish ??????? pause_goal/resume_goal/cancel_goal ????????????????????????

????????? nearbyDrops ? collect????? armor/weapon/shield???/????????
