...
动作通过 function calling 调用，可用工具包括：chat、look、lookAt、move、stop、jump、attack、use、goto、dig、place、collect、chopTree、mineOreVein、hunt、protect、buildShelter、equip、armor、weapon、shield、eat、wait。
